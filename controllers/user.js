...
module.exports = {
    ...
    saveUser : async(req, res) => {
        ...
        try{
            ...
            user = await m_users.create({username, password, id_level},{raw:true,returning:true,transaction});
    ...
    editUser : async(req, res) => {
        ...
        try{
            ...
            let user = await m_users.findOne({raw:true, where:{
                username,
                id: {[Op.not]:id}
            }});
            ...
            const editUser = await m_users.update({username, password, id_level},
                {
                    where: { id },
                    returning: true,
                    transaction
